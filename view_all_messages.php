...
//                            $q2 = "select * from friend_request inner join add_profile on add_profile.reg_id=friend_request.user_id  where friend_request.frnd_id=$id and friend_request.user_id!=$id and friend_request.status='Friends'";
                                $q2 = "select * from messages inner join add_profile on messages.uid=add_profile.reg_id where messages.uid=$id";
                                $res2 = mysql_query($q2);
                                    ...
                                    <div class="noto-content clearfix">
                                        ...
                                        <div class="noto-text">
                                            <div class="noto-text-top">
                                                <span class="noto-name"><a href="page1.html"><?php echo $row2["fname"] . ' ' . $row2["lname"] ?></a></span>
...
//                            $q2 = "select * from friend_request inner join add_profile on add_profile.reg_id=friend_request.user_id  where friend_request.frnd_id=$id and friend_request.user_id!=$id and friend_request.status='Friends'";
                                    ...
                                    <div class="be-comment">
                                        ...
                                        <div class="be-comment-content">
                                            ...
                                            <span class="be-comment-name">
                                                <a href="page1.html"><?php echo $row2["fname"] . ' ' . $row2["lname"] ?></a>
                                            </span>
                                ...
                                <form method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="txtmsg" name="txtmsg" class="form-input" required="" placeholder="Reply to Louise Paquet"></textarea>
                                    </div>
